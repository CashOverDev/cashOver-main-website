...
const Page = (props) => {
  return (
    <div className="page-container">
      ...
      <header data-thq="thq-navbar" className="page-navigation-bar-home">
        <img
          alt="logo"
        ...
        <div data-thq="thq-navbar-nav" className="page-desktop-menu">
          <nav className="page-links">
            <a href="#Services" className="page-link">
              <span className="page-text">Services</span>
              <br></br>
            </a>
            <Link to="/agent-atm-hosting" className="page-navlink">
              Become Agent
            </Link>
            <span className="page-text02">Business</span>
            <span className="page-text03">Support</span>
            <a
          ...
          <div className="page-buttons">
            <button type="button" className="page-login button">
              Login
            </button>
        ...
        <div data-thq="thq-mobile-menu" className="page-mobile-menu">
          <div className="page-nav">
            ...
            <nav className="page-links1">
              <span className="page-text04">About</span>
              <span className="page-text05">Features</span>
              <span className="page-text06">Pricing</span>
              <span className="page-text07">Team</span>
              <span className="page-text08">Blog</span>
            </nav>
      ...
      <div className="page-column">
        <span className="page-text09">404</span>
        ...
        <span className="page-text11">Go back Home and continue exploring</span>
