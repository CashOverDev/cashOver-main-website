...
import './cash-over-sd-ks.css'

const CashOverSDKs = (props) => {
  return (
    <div className="cash-over-sd-ks-container">
      <Helmet>
        <title>CashOver-SDKs - CashOver Pay | Ultimate Finance App</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="CashOver-SDKs - CashOver Pay | Ultimate Finance App"
        />
        <meta
      ...
      <nav className="cash-over-sd-ks-navigation-bar-sdk">
        <header
          data-thq="thq-navbar"
          className="cash-over-sd-ks-navbar-interactive"
        >
          <Link to="/" className="cash-over-sd-ks-navlink">
            <img alt="CashOver Logo" src="/cashover%20banner%20dark.png" />
          </Link>
          <div
            data-thq="thq-navbar-nav"
            className="cash-over-sd-ks-desktop-menu"
          >
            <nav className="cash-over-sd-ks-links">
              <a
                href="https://docs.cashover.io/web"
                target="_blank"
                rel="noreferrer noopener"
                className="cash-over-sd-ks-link1 thq-link thq-body-small"
              >
                Web SDK
              </a>
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="cash-over-sd-ks-link2 thq-link thq-body-small"
              >
                iOS SDK
              </a>
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="cash-over-sd-ks-link3 thq-link thq-body-small"
              >
                Android SDK
              </a>
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="cash-over-sd-ks-link4 thq-link thq-body-small"
              >
                Pricing
              </a>
              <Link
                to="/support"
                className="cash-over-sd-ks-link5 thq-link thq-body-small"
              >
                Support
              </Link>
            </nav>
            <div className="cash-over-sd-ks-buttons">
          ...
          <div
            ...
            className="cash-over-sd-ks-burger-menu"
          >
            <svg viewBox="0 0 1024 1024" className="cash-over-sd-ks-icon">
              <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
            </svg>
          </div>
          <div
            data-thq="thq-mobile-menu"
            className="cash-over-sd-ks-mobile-menu"
          >
            <div className="cash-over-sd-ks-nav">
              <div className="cash-over-sd-ks-top">
                <img
                  alt="CashOver Logo"
                  src="https://play.teleporthq.io/static/svg/placeholders/no-image.svg"
                  className="cash-over-sd-ks-logo"
                />
                <div
                  data-thq="thq-close-menu"
                  className="cash-over-sd-ks-close-menu"
                >
                  <svg
                    viewBox="0 0 1024 1024"
                    className="cash-over-sd-ks-icon02"
                  >
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              <nav className="cash-over-sd-ks-links1">
      ...
      <header className="cash-over-sd-ks-column">
        <div className="cash-over-sd-ks-dummy"></div>
        <div className="cash-over-sd-ks-column1">
          <h1 className="cash-over-sd-ks-text">CASHOVER PAY SDK</h1>
          <div className="cash-over-sd-ks-row">
            <h2 className="cash-over-sd-ks-text01">
              ACCEPT PAYMENTS ON ALL PLATFORMS
            </h2>
            <svg
              viewBox="0 0 796.0137142857142 1024"
              className="cash-over-sd-ks-icon10"
            >
            ...
            <svg viewBox="0 0 1024 1024" className="cash-over-sd-ks-icon12">
            ...
            <svg viewBox="0 0 1280 1024" className="cash-over-sd-ks-icon14">
          ...
          <div className="cash-over-sd-ks-container1">
            <a
              href="https://docs.cashover.money"
              target="_blank"
              rel="noreferrer noopener"
              className="cash-over-sd-ks-action12 thq-button-filled-dark"
            >
              Get Started
            </a>
            <a
              href="#Features"
              className="cash-over-sd-ks-action22 thq-button-outline-dark"
            >
              Learn More
            </a>
          </div>
        </div>
        <div className="cash-over-sd-ks-row1">
          <svg viewBox="0 0 1024 1024" className="cash-over-sd-ks-icon18">
            <path d="M316 366l196 196 196-196 60 60-256 256-256-256z"></path>
          </svg>
          <span className="cash-over-sd-ks-text02">
            Scroll Down to Learn The Features
          </span>
          <svg viewBox="0 0 1024 1024" className="cash-over-sd-ks-icon20">
            <path d="M316 366l196 196 196-196 60 60-256 256-256-256z"></path>
          </svg>
        </div>
      </header>
      <main id="Features" className="cash-over-sd-ks-column2">
        <h2 className="cash-over-sd-ks-text03">
          <span className="cash-over-sd-ks-text04">
          ...
          <span className="cash-over-sd-ks-text05">LACKS!</span>
          <br></br>
        </h2>
        <p className="cash-over-sd-ks-text07">
          <span>
        ...
        <div className="cash-over-sd-ks-row2">
          <div className="cash-over-sd-ks-feature">
            <img
              alt="image"
              src="/cart.png"
              className="cash-over-sd-ks-image"
            />
            <div className="cash-over-sd-ks-box">
              <div className="cash-over-sd-ks-column3">
                <h3 className="cash-over-sd-ks-text10">Accept Payments</h3>
                <p className="cash-over-sd-ks-text11">
          ...
          <div className="cash-over-sd-ks-feature1">
            <img
              alt="image"
              src="/features.png"
              className="cash-over-sd-ks-image1 cash-over-sd-ks-image1"
            />
            <div className="cash-over-sd-ks-box1">
              <div className="cash-over-sd-ks-column4">
                <h3 className="cash-over-sd-ks-text12">
                  Cheap, Like Really Cheap!
                </h3>
                <p className="cash-over-sd-ks-text13">
          ...
          <div className="cash-over-sd-ks-feature2">
            <img
              alt="image"
              src="/online.png"
              className="cash-over-sd-ks-image2"
            />
            <div className="cash-over-sd-ks-box2">
              <div className="cash-over-sd-ks-column5">
                <h3 className="cash-over-sd-ks-text14">Merchant Account</h3>
                <p className="cash-over-sd-ks-text15">
