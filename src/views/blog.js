...
const Blog = (props) => {
  return (
    <div className="blog-container">
      ...
      <header data-thq="thq-navbar" className="blog-navigation-bar-home">
        <img
          alt="logo"
        ...
        <div data-thq="thq-navbar-nav" className="blog-desktop-menu">
          <nav className="blog-links">
            <Link to="/" className="blog-navlink">
              <span className="blog-text">Services</span>
              <br></br>
            </Link>
            <Link to="/agent-atm-hosting" className="blog-navlink1">
              Become Agent
            </Link>
            <span className="blog-text2">Business</span>
            <span className="blog-text3">Support</span>
            <a
          ...
          <div className="blog-buttons">
            <button type="button" className="blog-login button">
              Login
            </button>
        ...
        <div data-thq="thq-mobile-menu" className="blog-mobile-menu">
          <div className="blog-nav">
            ...
            <nav className="blog-links1">
              <span className="blog-text4">About</span>
              <span className="blog-text5">Features</span>
              <span className="blog-text6">Pricing</span>
              <span className="blog-text7">Team</span>
              <span className="blog-text8">Blog</span>
            </nav>
            <div className="blog-buttons1">
              <button className="blog-login1 button">Login</button>
              <button className="button">Register</button>
            </div>
          </div>
          <div>
            <svg viewBox="0 0 950.8571428571428 1024" className="blog-icon04">
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="blog-icon06">
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="blog-icon08">
