...
const OurFees = (props) => {
  return (
    <div className="our-fees-container">
      <Helmet>
        <title>Our-Fees - CashOver Pay | Ultimate Finance App</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Our-Fees - CashOver Pay | Ultimate Finance App"
        />
        <meta
      ...
      <header className="our-fees-hero">
        <div className="our-fees-dummy"></div>
        <div className="our-fees-column">
          <h1 className="our-fees-text">Have a Look At Our Fees</h1>
          <p className="our-fees-text01">
            <span>
          ...
          <div className="our-fees-row">
            <a href="#Account" className="our-fees-link">
              Personal
            </a>
            <a href="#Merchant" className="our-fees-link1">
              Merchant
            </a>
            <a href="#Business" className="our-fees-link2">
              Business
            </a>
            <a href="#SDK" className="our-fees-link3">
              CashOver SDK
            </a>
          </div>
        </div>
        <div className="our-fees-row1">
          <svg viewBox="0 0 1024 1024" className="our-fees-icon">
            <path d="M316 366l196 196 196-196 60 60-256 256-256-256z"></path>
          </svg>
          <span className="our-fees-text04">Scroll Down To View</span>
          <svg viewBox="0 0 1024 1024" className="our-fees-icon2">
            <path d="M316 366l196 196 196-196 60 60-256 256-256-256z"></path>
          </svg>
        </div>
      </header>
      <section id="Account" className="our-fees-personal">
        <div className="our-fees-row2">
          <img
            alt="image"
            src="/cashover-200w.png"
            className="our-fees-image"
          />
          <h2 className="our-fees-cash-over">CashOver account fees</h2>
        </div>
        <span className="our-fees-text05">General</span>
        <div className="our-fees-container01">
          <div className="our-fees-container02">
            <React.Fragment>
              <React.Fragment>
                <style
        ...
        <span className="our-fees-text06">Deposits</span>
        <div className="our-fees-container03">
          <div className="our-fees-container04">
            <React.Fragment>
              <React.Fragment>
                <style
                  dangerouslySetInnerHTML={{
        ...
        <span className="our-fees-text07">US Dollars Withdrawals</span>
        <div className="our-fees-container05">
          <div className="our-fees-container06">
            <React.Fragment>
              <React.Fragment>
                <style
                  dangerouslySetInnerHTML={{
        ...
        <span className="our-fees-text08">Lebanese Lira Withdrawals</span>
        <div className="our-fees-container07">
          <div className="our-fees-container08">
            <React.Fragment>
              <React.Fragment>
                <style
                  dangerouslySetInnerHTML={{
      ...
      <section id="Merchant" className="our-fees-merchant">
        <div className="our-fees-row3">
          <img
            alt="image"
            src="/cashover%20merchant-200h.png"
            className="our-fees-image1"
          />
          <h2 className="our-fees-cash-over1">Merchant account fees</h2>
        </div>
        <span className="our-fees-text09">
        ...
        <Link
          to="/merchant"
          className="our-fees-action2 thq-button-outline button"
        >
          Learn More
        </Link>
      </section>
      <section id="Business" className="our-fees-business">
        <div className="our-fees-row4">
          <img
            alt="image"
            src="/cashover%20business.png"
            className="our-fees-image2"
          />
          <h2 className="our-fees-cash-over2">Business account Pricing</h2>
        </div>
        <div className="our-fees-container09">
          <div className="our-fees-container10">
            <React.Fragment>
              <React.Fragment>
                <style
                  dangerouslySetInnerHTML={{
      ...
      <section id="SDK" className="our-fees-sd-ks">
        <div className="our-fees-row5">
          <img
            alt="image"
            src="/cashover%20business.png"
            className="our-fees-image3"
          />
          <h2 className="our-fees-cash-over3">CASHOVER SDK USAGE Pricing</h2>
        </div>
        <span className="our-fees-text10">
          <span>
          ...
          <Link to="/support" className="our-fees-navlink">
            contact us
          </Link>
          <span>.</span>
        </span>
