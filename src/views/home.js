    ...
    <div className="home-container">
          ...
          <div className="home-column06">
            <div className="home-box1">
              ...
              <h2 className="home-text050">
                ...
                <span className="home-text052">USDT</span>
                <span className="home-text053"> On Your</span>
                <br></br>
              </h2>
              <h2 className="home-text055">CashOver Wallet</h2>
              <h2 className="home-text056">From</h2>
              <dd className="home-li2 list-item">
                <p className="home-text057">Anyone</p>
              </dd>
              <dd className="home-li3 list-item">
                <p className="home-text058">Anywhere</p>
              </dd>
              <dd className="home-li4 list-item">
                <p className="home-text059">Any Wallet</p>
              </dd>
              <h2 className="home-text060">
                <span>Or request any currency with your</span>
                <br></br>
              </h2>
              <h2 className="home-text063">
      ...
      <main className="home-column07">
        <h2 className="home-text066">
          ...
          <span className="home-text068">BUY</span>
          ...
          <span className="home-text070">SELL</span>
        </h2>
        <p className="home-text071">
        ...
        <div className="home-row04">
          ...
          <div className="home-column08">
            <h2 className="home-text072">Enjoy Tether to USD Swaps At Only</h2>
            <h3 className="home-text073">0.5%</h3>
            <p className="home-text074">
              ...
              <span className="home-text076">Lowest</span>
              <span className="home-text077"> Conversion Fee Ever.</span>
              ...
              <span className="home-text080">Any Platform</span>
              <span className="home-text081"> Out There.</span>
              ...
              <span className="home-text084">All Your Crypto</span>
              <span className="home-text085">.</span>
            </p>
          </div>
        </div>
      </main>
      <main className="home-column09">
        <div className="home-column10">
          <h2 className="home-text086">Choose What You Need</h2>
              ...
              <div className="home-column11">
                <main className="home-column12">
                  <div className="home-row07">
                    ...
                    <h3 className="home-text087">Personal</h3>
                  </div>
                  <h4 className="home-text088">
                    Your personal account for all your personal needs
                  </h4>
                  <p className="home-text089">
              ...
              <div className="home-column13">
                <div className="home-column14">
                  <div className="home-row08">
                    ...
                    <h3 className="home-text090">Merchant</h3>
                  </div>
                  <h4 className="home-text091">
                    scan, pay, receive. super fast!
                  </h4>
                  <p className="home-text092">
              ...
              <div className="home-column15">
                <div className="home-column16">
                  <div className="home-row09">
                    ...
                    <h3 className="home-text093">Business</h3>
                  </div>
                  <h4 className="home-text094">
                    Enterprise Finance Management
                  </h4>
                  <p className="home-text095">
          ...
          <div className="home-row10">
              ...
              <div className="home-column17">
                <main className="home-column18">
                  <div className="home-row11">
                    ...
                    <h3 className="home-text096">Custom Finance Solutions</h3>
                  </div>
                  <h4 className="home-text097">
            ...
            <Link to="/cash-over-sd-ks" className="home-navlink2">
              <div className="home-column19">
                <div className="home-column20">
                  <div className="home-row12">
                    ...
                    <h3 className="home-text099">CashOver SDK</h3>
                  </div>
                  <h4 className="home-text100">
                    Add CashOver on your platform
                  </h4>
                  <p className="home-text101">
          ...
          <h1 className="home-text102">What are you waiting for?</h1>
          <h2 className="home-text103">
          ...
          <div className="home-row13">
            ...
            <Link to="/cash-over-sd-ks" className="home-navlink5">
              <img
                alt="image"
