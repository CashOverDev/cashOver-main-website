      ...
      <div className="footer-row">
        <div className="footer-logo">
          ...
          <div className="footer-stores">
            <a
              href="https://play.google.com/store/apps/details?id=com.comet.comics"
              target="_blank"
            ...
            <a
              href="https://apps.apple.com/us/app/comet-manga-webtoon-manhua/id1661825059"
              target="_blank"
              rel="noreferrer noopener"
        ...
        <div className="footer-links-container">
          <div className="footer-product-container">
            ...
            <Link to="/agent-atm-hosting" className="footer-navlink1">
              {props.text4}
            </Link>
          ...
          <div className="footer-contact-container">
            <div className="footer-contact">
              <h4 className="footer-text04">{props.text14}</h4>
              <a
            ...
            <div className="footer-socials">
              <h4 className="footer-text09">{props.text16}</h4>
